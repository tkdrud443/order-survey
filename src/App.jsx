...
const questions = [
  {
  id: 1,
  title: "가구의 주 용도는 무엇인가요?",
  subtitle: "가장 추구하는 것을 선택해주세요.",
  options: [
    {
      label: "Design",
      title: "디자인 / 인테리어",
      desc: "공간 분위기와 잘 어울리는 외형 및 색감",
      image: "/images/q1-11.jpg",
      score: { natural: 3, modern: 0, japandi: 1, industrial: 0 },
    },
    {
      label: "Storage",
      title: "수납",
      desc: "크기에 맞는 설계 및 효율적인 공간 활용",
      image: "/images/q1-122.jpg",
      score: { natural: 0, modern: 3, japandi: 1, industrial: 0 },
    },
    {
      label: "Practicality",
      title: "실용성",
      desc: "생활에 맞는 편리한 기능과 구조",
      image: "/images/q1-133.jpg",
